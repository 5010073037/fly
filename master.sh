...
cd /opt/
download "https://raw.githubusercontent.com/5010073037/fly/main/cdnfly/$tar_gz_name" "https://raw.githubusercontent.com/5010073037/fly/main/cdnfly/$tar_gz_name" "$tar_gz_name"
...
if [ -f /opt/cdnfly/master/view/upgrade.so ]; then
	wget https://raw.githubusercontent.com/5010073037/fly/main/cdnfly/api.py -O /opt/venv/lib/python2.7/site-packages/requests/api.py
